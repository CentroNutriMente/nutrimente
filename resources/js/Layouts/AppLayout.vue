...
const navItems = [
    ...
    { name: 'Clienti',        href: 'patients.index',      icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
    ...
    { name: 'Social',         href: 'social.index',        icon: 'M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z' },
];

const isActive = (routeName) => {
    try {
        if (routeName === 'report-templates.index') {
